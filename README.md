# Aula 05: Teste Hipotese e Intervalo Confiança para Variância, Testes de Associação e ANOVA



Nesta aula vimos como utilizar testes de Hipósteses, Intervalos de confiança para Variância entre amostras e testes de associação e ANOVA.
...
```bash
git clone https://github.com/EbaPed/EBA-aula05-TesteHipoteseIntervaloConfianca.git
cd EBA-aula05-TesteHipoteseIntervaloConfianca
```
